...
<script type="text/javascript" >
    ...
    $(document).ready(function(){
    	...
    	//alert(url.substr(0,url.indexOf(":",1)));    
    	var portnum = ${bcode};
    	...
    	//	alert("웹소켓 연결됨!!");
            ...
            websocket.send(JSON.stringify(messageObj));
                        ...
                        */
            /* $("#chatMessage").append("<div class='row message-bubble'><p class='text-muted'>${sessionScope.loginuser.name}</p><span>"+$("#message").val()+"</span></div>");*/
...
<body>
    ...
    <div class="row">
        <div class="panel panel-default">
          <div class="panel-heading">채팅방</div>
          <div class="panel-body">
            <div class="container" id="scrollview" style="overFlow: auto; max-height: 400px;">
				<div id="chatMessage">
