...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#btnWrite").click(function(){
			...
			frm.action = "<%=request.getContextPath()%>/addNoticeEnd.action";
			frm.method = "post";
			frm.submit();
...
<div align="center" style="margin-bottom: 0.2%;">
	<h3>공지사항 등록</h3> 
...
--%> 
	<%-- ==== #134. 파일첨부하기 
	                    먼저,위의 <form name="writeFrm"> 을 주석처리한 후 
    ...
    --%>
		...
		<div align="center" style="margin-bottom: 30px;">
			<button type="button" id="btnWrite" style="background-color: #468EDE; color: #FFFFFF;">등록</button>
