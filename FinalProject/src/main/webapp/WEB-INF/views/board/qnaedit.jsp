...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$("#btnUpdate").click(function() {
			...
			frm.action = "<%=request.getContextPath()%>/qnaeditEnd.action";
			frm.method = "post";
			frm.submit();
		});
...
<div align="center" style="margin-bottom: 50px;">	
	...
	<table id="table">
		...
		<tr>
			...
			<td>
				<!-- 스마트 에디터 사용 전 -->
				<%-- <textarea id="content" rows="10" cols="100">${fn:replace(boardvo.content, "<br>", "&#10;")}</textarea> --%>
				
				<!-- 스마트 에디터 사용 후 -->
				<textarea id="content" rows="10" cols="100">${boardvo.content}</textarea>
