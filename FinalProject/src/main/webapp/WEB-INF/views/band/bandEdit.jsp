...
<div class="container">
	<h3 style="padding-top: 20px; text-align: center;">밴드 수정</h3>
	
	 <%-- >>>> 파일첨부하기
	 	       enctype="multipart/form-data" 을 해주어야만 파일첨부가 된다. --%>
	<form name="editFrm" action="<%= request.getContextPath() %>/bandEditEnd.action" method="post" enctype="multipart/form-data" >
		<table id="table" class="table table-bordered" style="width: 100%; margin-top: 50px;">
			<tr>
				<th>밴드명&nbsp;<span class="error">필수입력</span></th>
				<td>
					<div style="width: 30%;">
					  <input type="hidden" id="bcode" name="bcode" value="${bandvo.bcode}"/ >
					  <input type="text" id=bname name=bname class="requiredInfo" value="${bandvo.bname}"/>
			...
			<tr>
				...
				<td>
				    <div style="width: 50%;">
				    	<select class="requiredInfo" id="bthema" name="bthema" value="${bandvo.bthema}">
			...
			<tr>
            	...
            	<td><textarea id="binfo" name="binfo" class="requiredInfo" rows="7" >${bandvo.binfo}</textarea></td>
         	</tr>
		</table>
		<br/>

        <!-- <input name="submit" type="submit" id="submit" class="submit" value="Post Comment"> -->
		<button type="button" id="btnRegister" class="btn btn-secondry btn-info"  style="margin-right: 10px; margin-bottom: 10px; " onClick="goBandEdit(event);">밴드수정</button>
