...
public class BoardVO {
	...
	// 먼저, 오라클에서 tblBoard테이블에 commentCount 컬럼을 추가해야 한다.
	private String commentCount; // 댓글수
	
	// ==== #118. 답변형 게시판을 위한 멤버변수 추가하기
	// 먼저, 오라클에서 tblBoard테이블과 tblComment테이블을 기존것은 제거한 후
	...
	*/
	...
	// ==== #133. 파일첨부를 하도록 VO수정하기 ====
	/*
		먼저, 오라클에서 tblBoard테이블에 3개 컬럼(fileName, orgFilename, filesize)을
		추가한 다음에 아래의 작업을 해야한다.
	*/
