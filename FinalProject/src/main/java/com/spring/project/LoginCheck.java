...
public class LoginCheck {
		...
		public void before(JoinPoint joinPoint) {
			...
			// 보조업무 구현
			// - 해당 요청자가 인증받지 못한 상태라면 회원 전용 페이지에 접근할 수 없기에 다른 페이지(/WEB-INF/viewsnotiles/msg.jsp)로 강제이동시킨다.
			if(session.getAttribute("loginuser") == null) {
				try {
					
					String msg = "먼저 로그인하세요.";
					String loc = "/final/login.action";
					...
					// response.sendRedirect("/board/login.action");
