...
public class GoogleMail {
    ...
    public void sendmail(String recipient, String certificationCode)  
    	...
    	prop.put("mail.smtp.user", "eclass180122@gmail.com");
    	...
    	// 제목 설정
    	String subject = "localhost:9090/MyMVC/mall.do 회원님의 비밀번호를 찾기위한 인증코드 발송";
    	msg.setSubject(subject);
    	        
    	// 보내는 사람의 메일주소
    	String sender = "eclass180122@gmail.com";
    ...
    public void sendmail_IbgoFinish(String recipient, String emailContents)  
    	...
    	// 제목 설정
    	String subject = "localhost:9090/board/ 입고가 성공했습니다. ";
    	msg.setSubject(subject);
